...
# Load data
df = pd.read_csv('../data/vdot-paces-jack-daniels-running-formula-2-modified.csv')
...
coefs = pd.DataFrame(params, columns=['Pace', 'Intercept', 'Coef1', 'Coef2', 'Coef3', 'Coef4'])
coefs.to_csv('../data/vdot-to-pace-coefficients.csv', index=False)